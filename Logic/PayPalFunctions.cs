...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-hnpky13307737_api1.business.example.com";
    private string APIPassword = "SZDS3WKD6NSZDEBV";
    private string APISignature = "AwsY9US4HFPqe0AuoaqJ-OSIasthAJBccmJbrkQVwkZ2aZZsfhw-41v2";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (PinProject.Logic.ShoppingCartActions myCartOrders = new PinProject.Logic.ShoppingCartActions())
        {
